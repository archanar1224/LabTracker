...
app.controller('EmbedController',function($scope,$http,$window,$cookieStore)
{
    ...
    $scope.completeBlock=function () 
    {
    	// Call the rest api to complete the action on this block
    	var url = ASSET_URL_BASE + "/completeblock?assetId="+$scope.blockIdValue;
    	console.log("complete block in js "+$scope.blockIdValue);
    	 $http.post(url).success(function() 
    	{
            console.log("complete block success");
            alert("Embedding done successfully");
        })
        .error(function() {
        	alert("Error in embedding. Please scan again");
